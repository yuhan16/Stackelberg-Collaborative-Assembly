import numpy as np
import torch
from .model import LeaderQNetNash, FollowerQNetNash, LeaderQNetInd, FollowerQNetInd
...
class LeaderNash:
    ...
    def __init__(self, parameters, env) -> None:
        ...
        self.onlineQ = LeaderQNetNash(parameters, self.dims, self.dimAl, self.dimAf)
        self.targetQ = LeaderQNetNash(parameters, self.dims, self.dimAl, self.dimAf)
...
class FollowerNash:
    ...
    def __init__(self, parameters, env) -> None:
        ...
        self.onlineQ = FollowerQNetNash(parameters, self.dims, self.dimAl, self.dimAf)
        self.targetQ = FollowerQNetNash(parameters, self.dims, self.dimAl, self.dimAf)
        self.onlineQ.to(self.device)
        self.targetQ.to(self.device)
...
class LeaderInd:
    ...
    def __init__(self, parameters, env) -> None:
        ...
        self.onlineQ = LeaderQNetInd(parameters, self.dims, self.dimAl)
        self.targetQ = LeaderQNetInd(parameters, self.dims, self.dimAl)
        self.onlineQ.to(self.device)
        self.targetQ.to(self.device)
...
class FollowerInd:
    ...
    def __init__(self, parameters, env) -> None:
        ...
        self.onlineQ = FollowerQNetInd(parameters, self.dims, self.dimAf)
        self.targetQ = FollowerQNetInd(parameters, self.dims, self.dimAf)
        self.onlineQ.to(self.device)
        self.targetQ.to(self.device)
